...
import useOctaneConfigStore from "./useOctaneConfigStore";
import useTransferFormStore, { ATAState } from "./useTransferFormStore";
...
const EXAMPLE_RECIPIENT = '2y17As4NmPaVx2QnNviJx1PSXeLbv4aRzCgWxsi8GHL8';
...
export const TransferView: FC = ({ }) => {
  ...
  const submitTransfer = useCallback(async () => {
    ...
    console.log("Signed tx", base58.encode(signedTransferTransaction.serialize({requireAllSignatures: false})),)
